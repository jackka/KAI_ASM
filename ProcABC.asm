...
comment &
 ...
 After_Random_Calc: 
    ...
    outwordln AL				;вывод значени€ X[i]
 ...
 Random_Calc:
	...
	jcxz return				;если cx=0 (введены все числа), то процедура заканчиваетс€
...
;выбор п€ти пар родителей, у каждой пары один потомок, итого 5 новых решений
; 10 000 сторонн€€ игральна€ кость, веро€тности каждого родител€=fitness.  ј  ¬џЅ–ј“№ Ќќ¬”ё ѕј–” –ќƒ»“≈Ћ≈…?
...
;выбираетс€ часть, которыми будут обмениватьс€
; ???–ј«ƒ≈Ћ»“≈Ћ№ Ќј ЋёЅќћ Ѕ»“≈?
